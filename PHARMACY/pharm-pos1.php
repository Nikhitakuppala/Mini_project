...
<body>
	...
	?>
			...
			<form method="post">
					...
					<input type="number" name="medid" value="<?php echo isset($row4[0]) ? $row4[0] : ''; ?>" readonly><br><br>
					...
					<input type="number" name="mqty" value="<?php echo isset($row4[2]) ? $row4[2] : ''; ?>" readonly><br><br>
					
					<label for="mprice">Price of One Unit:</label>
					<input type="number" name="mprice" value="<?php echo isset($row4[4]) ? $row4[4] : ''; ?>" readonly><br><br>
